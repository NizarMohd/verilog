...
HD_PWD='C:/Users/User/Downloads/Lab1_Monday_PM_Mohamed Nizar Bin Mohamed Hussain_A0183398M_Archive.xpr/Lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log module_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source module_control.tcl
